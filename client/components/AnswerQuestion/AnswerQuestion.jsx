...
export default class AnswerQuestion extends React.Component {
	...
	updateHeaderClass() {
		...
		if(this.state.correct === null)
			this.setState({headerClass: this.headerBaseClass});
		else if(this.state.correct)
			this.setState({headerClass: `${this.headerBaseClass} ${this.headerBaseClass}--correct`});
		else
			this.setState({headerClass: `${this.headerBaseClass} ${this.headerBaseClass}--wrong`});	
	}
			...
			<section className="answer-questions">
				...
				<main >
					{this.quiz.answers.map((answer, index) => 
						<div key={index}>
							<Radio name={this.state.currentIndex}
				...
				<footer className="answer-questions__footer">
					<Button disabled={this.state.selectedAnswer === null}
